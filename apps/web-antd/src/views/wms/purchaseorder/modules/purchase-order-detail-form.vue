...
watch(
    ...
    async (val) => {
      ...
      await nextTick();
      await gridApi.grid.loadData(await getPurchaseOrderDetailListByPurchaseOrderId(props.purchaseOrderId!));
    },
    { immediate: true },
);
</script>
...
<template>
  ...
  <div class="flex justify-center -mt-4">
    <Button :icon="h(Plus)" type="primary" ghost @click="onAdd" v-access:code="['wms:purchase-order:create']">
